          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.totalSchemesMainContainer}>
              <View style={styles.schemesColContainer}>
                <Text style={styles.schemesCountTextStyle}>8</Text>
              ...
              <View style={styles.brandCardCardBG}>
                ...
                <View style={styles.schemesDetailsContainer}>
                  <Text style={styles.schemesDetailsTextStyle}>
                    Scheme details in 2 lines. Scheme details in 2 lines. Scheme
                    details in 2 lines. Scheme details in 2 lines.
                  </Text>
                </View>
                {/* Dash line */}
                ...
                <View style={styles.PLDateainContainer}>
                  <View style={styles.publishDateColContainer}>
                    ...
                    <Text style={styles.publishDateTextStyle}>20 Dec 2019</Text>
                  </View>
                  <View style={styles.lastDateColContainer}>
                    <Text style={styles.lastDateLabelStyle}>LAST DATE</Text>
                    <Text style={styles.lastDateTextStyle}>12 Jan 2020</Text>
                  </View>
