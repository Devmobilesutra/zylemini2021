    ...
    if (item.sync_flag == 'N') {
        ...
        <View style={styles.deliveryStatusContainer}>
          ...
          <View style={styles.deliveryStusMainContainer}>
            ...
            <View style={styles.viewDetailsMainContainer}>
              <TouchableOpacity
                onPress={() => Actions.OrderViewDetails({OrderId: item.id})}>
      ...
      return (
        <View style={styles.deliveryStatusContainer}>
          <View style={styles.deliverySeparateContainer}>
            <View style={styles.deliveryColContainer}>
              <Text style={styles.deliveryLabelStyle}>DELIVERED</Text>
            </View>
          </View>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.totalShopsMainContainer}>
              <View style={styles.processColContainer}>
                ...
                <Text style={styles.inProcessHeadingTextStyle}>In-Process</Text>
              </View>
              <View style={styles.deliveredColContainer}>
                <Text style={styles.deliveredCountTextStyle}>
                  {orderDelevered}
                </Text>
                <Text style={styles.deliveredHeadingTextStyle}>Delivered</Text>
              </View>
              <View style={styles.totalCountMainContainer}>
                <Text style={styles.totalCountTextStyle}>{orderTotal}</Text>
                <Text style={styles.totalCountHeadingTextStyle}>Total</Text>
              </View>
              {/* Filter Icon */}
