                ...
                <View style={styles.modalView}>
                  <View style={{flexDirection: 'row'}}>
                    <View
                      ...
                      <Icon size={24} name="create" color="#CC1167" />
                    </View>
            ...
            <View style={styles.totalShopsMainContainer1}>
              <View style={styles.totalShopsMainContainer}>
                <View style={styles.totalShopColContainer}>
                  ...
                  <View style={{flex: 1, flexDirection: 'row'}}>
                    <Text style={styles.totalShopHeadingTextStyle}>80%</Text>
                ...
                <View style={styles.shopVisitedColContainer}>
                  ...
                  <View style={{flex: 1, flexDirection: 'row'}}>
                    <Text style={styles.totalShopHeadingTextStyle1}>+52%</Text>
              ...
              <View style={{flex: 2}}>
                ...
                <View
                  ...
                  <View
                    style={{flex: 2, flexDirection: 'row', marginTop: hp('1')}}>
                    <View
                      style={{
                        flex: 0.5,
                        flexDirection: 'row',
