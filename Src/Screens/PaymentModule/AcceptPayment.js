      ...
      <View style={{flex: 1}}>
        ...
        <View style={{flex: 1}}>
          <Text
            ...
            Add amount to be paid against each invoice
          </Text>
          {/* <ScrollView> */}
          <FlatList
            ...
            renderItem={item => (
              <AcceptPaymentSCreenListModel
                item={item}
                GetAmount={a => {
                  //TotleAmount = TotleAmount + parseInt(a);
                  console.log(a);

                  //this.setState({ _amount: _amount + a })
                }}
                ...
                GetItemDetail={detail => {
                  console.log('CHECK_VALUE::', detail);
                }}
              />
            )}
          />
        ...
        <View
          ...
          <View style={{marginLeft: 10}}>
            <Text
              ...
              TOTLE AMOUNT TO BE PAID
            </Text>
            <Text style={{color: Colors.White}}>{this.state._amount}</Text>
          </View>
          <TouchableWithoutFeedback
            onPress={() => {
