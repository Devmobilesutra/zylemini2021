...
export class sideordrDetails extends Component {
  ...
  _componentFocused = () => {
    ...
    AsyncStorage.getItem('apporderid').then(keyValue => {
      ...
      AsyncStorage.getItem('entityid').then(keyValue => {
        ...
        //   })
        db.getCustomerShopName(
          this.state.entityIdNew,
          this.state.app_order_id,
        ).then(data => {
  ...
  render() {
    ...
    const startDate1 = selectedStartDate1
      ? selectedStartDate1.toString()
      : newDate;
    const minDate1 = new Date(
      Date.now() - this.state.PREVIOUSDAYORDERDAYS * 24 * 60 * 60 * 1000,
    ); // Min date
          ...
          <ScrollView
            ...
            <View style={styles.container}>
              ...
              <View style={styles.orderDateContainer}>
                ...
                <Text style={styles.orderDatesDate}>
                  {moment(this.state.Shop_det[0].Current_date_time).format(
                    'DD-MMM-YYYY',
                  )}
                </Text>
                <Text style={styles.orderDateText1}>EXPECTED DELIVERY</Text>
                <Text style={styles.orderDatesDate}>
                  {moment(this.state.Shop_det[0].ExpectedDeliveryDate).format(
                    'DD-MMM-YYYY',
                  )}
                </Text>
            ...
            <View style={{flex: 0.1}}>
              <View style={styles.storeInfoMainContainer}>
                ...
                {this.state.Shop_det[0].sync_flag == 'N' ? (
                  <View style={styles.historyTextContainer}>
                    <TouchableOpacity
                      onPress={() =>
                        Actions.sideorderEdittNew({
                          entity_id: this.state.Shop_det[0].entity_id,
                          collection_type: this.state.Shop_det[0]
                            .collection_type,
                          order_Id: this.state.Shop_det[0].id,
                          OrderDate: this.state.Shop_det[0].Current_date_time,
                          Total_amount: this.state.Shop_det[0].total_amount,
                          ShopName: this.state.Shop_det[0].Party,
                          expectedDeliveryDate: this.state.Shop_det[0]
                            .ExpectedDeliveryDate,
                        })
                      }>
                      <Text style={styles.historyText}>Edit</Text>
                    </TouchableOpacity>
                  </View>
                ) : (
                  //  </TouchableOpacity>
            ...
            <View style={{flex: 0.1}}>
              <View style={styles.orderPreivewContainer}>
                <View style={styles.OrderPreviewTextContainer}>
                  <Text style={styles.orderPreviewText}>OREDER PREVIEW</Text>
                </View>
              </View>
            </View>
                        ...
                        <DialogContent>
                          ...
                          <View style={styles.schemesDescriptionMainContainer}>
                            <Text style={styles.descriptionTextStyle}>
                              Dummy Scheme Description.Dummy Scheme Description.
                              Dummy Scheme Description.Dummy Scheme Description.
                              Dummy Scheme Description.
                            </Text>
                          </View>
                ...
                <View style={styles.expectedDeliDateSelfContainer}>
                  <Text style={styles.expectedDeliDateTextStyle}>
                    <Text>
                      {' '}
                      {moment(
                        this.state.Shop_det[0].ExpectedDeliveryDate,
                      ).format('DD-MMM-YYYY')}
                    </Text>
                  </Text>
                </View>
            ...
            <View style={styles.remarkTextViewContainer}>
              <TextInput
                ...
                value={this.state.Shop_det[0].remark}
