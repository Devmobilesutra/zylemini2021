        ...
        <View style={styles.pastSurveysCardContainer}>
          <View style={styles.pastSurveysCardBG}>
            ...
            <View style={styles.pastSurveyContainer}>
              <Text style={styles.pastSurveyNameTextStyle}>Model Name</Text>
              <Text style={styles.companyNameTextStyle}>Product Type</Text>
              <Text style={styles.dateTimeTextStyle}>Product Location</Text>
            </View>
          </View>
        </View>
      );
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View>
              ...
              <View style={styles.nameMainContainer}>
                <Text style={styles.nameTextStyle}>CHOOSE PRODUCT TYPE</Text>
              </View>
              ...
              {/* Select Model  */}
              <View style={styles.nameMainContainer}>
                <Text style={styles.nameTextStyle}>SELECT MODEL</Text>
              </View>
              <View style={styles.nameTextBoxMainContainer}>
                <Dropdown
                  placeholder="Select"
              ...
              {/* Select Model  */}
              <View style={styles.nameMainContainer}>
                <Text style={styles.nameTextStyle}>MODEL</Text>
              </View>
              <View style={styles.nameTextBoxMainContainer}>
                <Dropdown
                  placeholder="Select"
              ...
              {/* Select Model  */}
              <View style={styles.nameMainContainer}>
                <Text style={styles.nameTextStyle}>SERIAL NUMBER</Text>
              </View>
              <View style={styles.nameTextBoxMainContainer}>
                <Dropdown
                  placeholder="Select"
