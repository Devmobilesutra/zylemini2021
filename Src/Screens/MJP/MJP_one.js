...
class MJP_one extends React.Component {
  ...
  NextDate(i) {
    ...
    try {
      ...
      db.GetMJPMasterDetails(this.state.Planned_dates[i].PlannedDate).then(
        data => {
          console.log('shop Card info', data);
          this.setState({Card_data: data});
        ...
        if (response.data.Data.Order) {
          ...
          Alert.alert(
            ...
            [
              ...
              {
                text: 'OK',
                onPress: () => this.props.navigation.navigate('MJP_one'),
              },
            ],
            {cancelable: false},
          );
          ...
          <View>
            <View style={{flexDirection: 'row'}}>
              <TouchableOpacity
                ...
                style={{marginTop: hp('4%'), marginLeft: wp('2%')}}>
                <Text style={{color: 'white', fontSize: wp('12%')}}>←</Text>
              </TouchableOpacity>
              <Text
                style={{
